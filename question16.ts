...
let guest2: string[]=[`Asad `, `Bilal `, `Ahmad `, `Hassan`];
for (let guest of guest2) {
    console.log(`Hello, ${guest}, We have found a bigger dinner table`)
}
let newguestatstart:string="Aaftab"
let newguestatmiddle: string="Zahid"
let newguestatend:string="Abid"

guest2.unshift(newguestatstart)
// console.log(guest2)

let middleIndex: number=Math.floor(guest2.length/2)
